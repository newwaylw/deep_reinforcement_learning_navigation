...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        # Q-Network
        h_size = 128
        self.qnetwork_local = QNetwork(state_size, action_size, h_size, seed).to(device)
        self.qnetwork_target = QNetwork(state_size, action_size, h_size, seed).to(device)
    ...
    def learn(self, experiences, gamma):
        ...
        values = rewards + (1- dones) * gamma * (y_targets) # if done (=1) then we just use reward value
